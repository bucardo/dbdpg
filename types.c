...
sql_type_info_t* pg_type_data(int sql_type)
{
    switch(sql_type) {
        ...
        case PG_PG_CLASS:                  return &pg_types[142];
        case PG_PG_DDL_COMMAND:            return &pg_types[143];
        case PG_PG_DEPENDENCIES:           return &pg_types[144];
        case PG_PG_LSN:                    return &pg_types[145];
        case PG_PG_MCV_LIST:               return &pg_types[146];
        case PG_PG_NDISTINCT:              return &pg_types[147];
        case PG_PG_NODE_TREE:              return &pg_types[148];
        case PG_PG_PROC:                   return &pg_types[149];
        case PG_PG_SNAPSHOT:               return &pg_types[150];
        case PG_PG_TYPE:                   return &pg_types[151];
        case PG_POINT:                     return &pg_types[152];
        case PG_POLYGON:                   return &pg_types[153];
        case PG_RECORD:                    return &pg_types[154];
        case PG_REFCURSOR:                 return &pg_types[155];
        case PG_REGCLASS:                  return &pg_types[156];
        case PG_REGCOLLATION:              return &pg_types[157];
        case PG_REGCONFIG:                 return &pg_types[158];
        case PG_REGDICTIONARY:             return &pg_types[159];
        case PG_REGNAMESPACE:              return &pg_types[160];
        case PG_REGOPER:                   return &pg_types[161];
        case PG_REGOPERATOR:               return &pg_types[162];
        case PG_REGPROC:                   return &pg_types[163];
        case PG_REGPROCEDURE:              return &pg_types[164];
        case PG_REGROLE:                   return &pg_types[165];
        case PG_REGTYPE:                   return &pg_types[166];
        case PG_TABLE_AM_HANDLER:          return &pg_types[167];
        case PG_TEXT:                      return &pg_types[168];
        case PG_TID:                       return &pg_types[169];
        case PG_TIME:                      return &pg_types[170];
        case PG_TIMESTAMP:                 return &pg_types[171];
        case PG_TIMESTAMPTZ:               return &pg_types[172];
        case PG_TIMETZ:                    return &pg_types[173];
        case PG_TRIGGER:                   return &pg_types[174];
        case PG_TSM_HANDLER:               return &pg_types[175];
        case PG_TSMULTIRANGE:              return &pg_types[176];
        case PG_TSQUERY:                   return &pg_types[177];
        case PG_TSRANGE:                   return &pg_types[178];
        case PG_TSTZMULTIRANGE:            return &pg_types[179];
        case PG_TSTZRANGE:                 return &pg_types[180];
        case PG_TSVECTOR:                  return &pg_types[181];
        case PG_TXID_SNAPSHOT:             return &pg_types[182];
        case PG_UNKNOWN:                   return &pg_types[183];
        case PG_UUID:                      return &pg_types[184];
        case PG_VARBIT:                    return &pg_types[185];
        case PG_VARCHAR:                   return &pg_types[186];
        case PG_VOID:                      return &pg_types[187];
        case PG_XID:                       return &pg_types[188];
        case PG_XID8:                      return &pg_types[189];
        case PG_XML:                       return &pg_types[190];
        default: return NULL;
    }
}
