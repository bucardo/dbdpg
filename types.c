...
static sql_type_info_t pg_types[] = {
	...
	{FLOAT4OID, "float4", quote_string, dequote_char, {SQL_REAL}, DBDPG_TRUE},
	{FLOAT8OID, "float8", null_quote, null_dequote, {SQL_FLOAT}, DBDPG_TRUE},
	...
	{TEXTOID, "text", quote_string, dequote_string, {SQL_LONGVARCHAR}, DBDPG_TRUE},
	{TIDOID, "tid", quote_geom, dequote_string, {0}, DBDPG_TRUE},
	{TIMEOID, "time", null_quote, null_dequote, {SQL_TYPE_TIME}, DBDPG_TRUE},
	{TIMESTAMPOID, "timestamp", quote_string, dequote_string, {SQL_TIMESTAMP}, DBDPG_TRUE},
...
static sql_type_info_t sql_types[] = {
	...
	{SQL_REAL, "SQL_REAL", quote_string, dequote_char, {FLOAT4OID}, DBDPG_TRUE},
	{SQL_NUMERIC, "SQL_NUMERIC", quote_string, dequote_char, {FLOAT4OID}, DBDPG_TRUE},
	{SQL_FLOAT, "SQL_FLOAT", null_quote, null_dequote, {FLOAT8OID}, DBDPG_TRUE},
	{SQL_DOUBLE, "SQL_DOUBLE", null_quote, null_dequote, {FLOAT8OID}, DBDPG_TRUE},
	{SQL_SMALLINT, "SQL_SMALLINT", null_quote, null_dequote, {INT2OID}, DBDPG_TRUE},
	{SQL_TINYINT, "SQL_TINYINT", null_quote, null_dequote, {INT2OID}, DBDPG_TRUE},
	...
	{SQL_UNKNOWN_TYPE, "SQL_UNKNOWN_TYPE", quote_string, dequote_string, {UNKNOWNOID}, DBDPG_TRUE},
...
for (sort keys %oid) {
	...
	printf OUT qq!\t{$_, "%s", %s, %s, \{%s\}, %s\},\n!,
		$type{$_}[0], $type{$_}[1], $type{$_}[2], $sqltype, ($type{$_}[1] ? "DBDPG_TRUE" : "DBDPG_FALSE");
	$pos{$_} = $item++;
}
...
TIMESTAMPOID, timestamp, quote_string, dequote_string, SQL_TIMESTAMP|SQL_TYPE_TIMESTAMP, 1
