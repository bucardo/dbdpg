...
static sql_type_info_t pg_types[] = {
 {PG_ABSTIMEARRAY      ,"_abstime"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 ...
 {PG_CIDARRAY          ,"_cid"             ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_CIDRARRAY         ,"_cidr"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_CIRCLEARRAY       ,"_circle"          ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_CSTRINGARRAY      ,"_cstring"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_DATEARRAY         ,"_date"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_FLOAT4ARRAY       ,"_float4"          ,',',"array_out"       ,quote_string,dequote_string,{0},1,2},
 {PG_FLOAT8ARRAY       ,"_float8"          ,',',"array_out"       ,quote_string,dequote_string,{0},1,2},
 {PG_GTSVECTORARRAY    ,"_gtsvector"       ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_INETARRAY         ,"_inet"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_INT2ARRAY         ,"_int2"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,1},
 {PG_INT2VECTORARRAY   ,"_int2vector"      ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_INT4ARRAY         ,"_int4"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,1},
 {PG_INT8ARRAY         ,"_int8"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_INTERVALARRAY     ,"_interval"        ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_LINEARRAY         ,"_line"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_LSEGARRAY         ,"_lseg"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_MACADDRARRAY      ,"_macaddr"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_MONEYARRAY        ,"_money"           ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_NAMEARRAY         ,"_name"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_NUMERICARRAY      ,"_numeric"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,2},
 {PG_OIDARRAY          ,"_oid"             ,',',"array_out"       ,quote_string,dequote_string,{0},1,1},
 {PG_OIDVECTORARRAY    ,"_oidvector"       ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_PATHARRAY         ,"_path"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_POINTARRAY        ,"_point"           ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_POLYGONARRAY      ,"_polygon"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REFCURSORARRAY    ,"_refcursor"       ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGCLASSARRAY     ,"_regclass"        ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGCONFIGARRAY    ,"_regconfig"       ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGDICTIONARYARRAY,"_regdictionary"   ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGOPERARRAY      ,"_regoper"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGOPERATORARRAY  ,"_regoperator"     ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGPROCARRAY      ,"_regproc"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGPROCEDUREARRAY ,"_regprocedure"    ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_REGTYPEARRAY      ,"_regtype"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_RELTIMEARRAY      ,"_reltime"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TEXTARRAY         ,"_text"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TIDARRAY          ,"_tid"             ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TIMEARRAY         ,"_time"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TIMESTAMPARRAY    ,"_timestamp"       ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TIMESTAMPTZARRAY  ,"_timestamptz"     ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TIMETZARRAY       ,"_timetz"          ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TINTERVALARRAY    ,"_tinterval"       ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TSQUERYARRAY      ,"_tsquery"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TSVECTORARRAY     ,"_tsvector"        ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_TXID_SNAPSHOTARRAY,"_txid_snapshot"   ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_UUIDARRAY         ,"_uuid"            ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_VARBITARRAY       ,"_varbit"          ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_VARCHARARRAY      ,"_varchar"         ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_XIDARRAY          ,"_xid"             ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_XMLARRAY          ,"_xml"             ,',',"array_out"       ,quote_string,dequote_string,{0},1,0},
 {PG_ABSTIME           ,"abstime"          ,',',"abstimeout"      ,quote_string,dequote_string,{0},1,0},
 {PG_ACLITEM           ,"aclitem"          ,',',"aclitemout"      ,quote_string,dequote_string,{0},1,0},
 {PG_ANY               ,"any"              ,',',"any_out"         ,quote_string,dequote_string,{0},1,0},
 {PG_ANYARRAY          ,"anyarray"         ,',',"anyarray_out"    ,quote_string,dequote_string,{0},1,0},
 {PG_ANYELEMENT        ,"anyelement"       ,',',"anyelement_out"  ,quote_string,dequote_string,{0},1,0},
 {PG_ANYENUM           ,"anyenum"          ,',',"anyenum_out"     ,quote_string,dequote_string,{0},1,0},
 {PG_ANYNONARRAY       ,"anynonarray"      ,',',"anynonarray_out" ,quote_string,dequote_string,{0},1,0},
 {PG_BIT               ,"bit"              ,',',"bit_out"         ,quote_string,dequote_string,{0},1,0},
 {PG_BOOL              ,"bool"             ,',',"boolout"         ,quote_bool  ,dequote_bool  ,{SQL_BOOLEAN},1,0},
 {PG_BOX               ,"box"              ,';',"box_out"         ,quote_geom  ,dequote_string,{0},1,0},
 ...
 {PG_CHAR              ,"char"             ,',',"charout"         ,quote_string,dequote_char  ,{SQL_CHAR},1,0},
 {PG_CID               ,"cid"              ,',',"cidout"          ,quote_string,dequote_string,{0},1,0},
 {PG_CIDR              ,"cidr"             ,',',"cidr_out"        ,quote_string,dequote_string,{0},1,0},
 {PG_CIRCLE            ,"circle"           ,',',"circle_out"      ,quote_circle,dequote_string,{0},1,0},
 {PG_CSTRING           ,"cstring"          ,',',"cstring_out"     ,quote_string,dequote_string,{0},1,0},
 ...
 {PG_GTSVECTOR         ,"gtsvector"        ,',',"gtsvectorout"    ,quote_string,dequote_string,{0},1,0},
 {PG_INET              ,"inet"             ,',',"inet_out"        ,quote_string,dequote_string,{0},1,0},
 {PG_INT2              ,"int2"             ,',',"int2out"         ,null_quote  ,null_dequote  ,{SQL_SMALLINT},1,1},
 {PG_INT2VECTOR        ,"int2vector"       ,',',"int2vectorout"   ,quote_string,dequote_string,{0},1,0},
 ...
 {PG_MACADDR           ,"macaddr"          ,',',"macaddr_out"     ,quote_string,dequote_string,{0},1,0},
 {PG_MONEY             ,"money"            ,',',"cash_out"        ,quote_string,dequote_string,{0},1,0},
 {PG_NAME              ,"name"             ,',',"nameout"         ,null_quote  ,null_dequote  ,{SQL_VARCHAR},1,0},
 {PG_NUMERIC           ,"numeric"          ,',',"numeric_out"     ,null_quote  ,null_dequote  ,{SQL_DECIMAL},1,2},
 {PG_OID               ,"oid"              ,',',"oidout"          ,null_quote  ,null_dequote  ,{0},1,1},
 {PG_OIDVECTOR         ,"oidvector"        ,',',"oidvectorout"    ,quote_string,dequote_string,{0},1,0},
 {PG_OPAQUE            ,"opaque"           ,',',"opaque_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_PATH              ,"path"             ,',',"path_out"        ,quote_path  ,dequote_string,{0},1,0},
 {PG_PG_ATTRIBUTE      ,"pg_attribute"     ,',',"record_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_PG_CLASS          ,"pg_class"         ,',',"record_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_PG_PROC           ,"pg_proc"          ,',',"record_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_PG_TYPE           ,"pg_type"          ,',',"record_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_POINT             ,"point"            ,',',"point_out"       ,quote_geom  ,dequote_string,{0},1,0},
 {PG_POLYGON           ,"polygon"          ,',',"poly_out"        ,quote_geom  ,dequote_string,{0},1,0},
 {PG_RECORD            ,"record"           ,',',"record_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_REFCURSOR         ,"refcursor"        ,',',"textout"         ,quote_string,dequote_string,{0},1,0},
 {PG_REGCLASS          ,"regclass"         ,',',"regclassout"     ,quote_string,dequote_string,{0},1,0},
 {PG_REGCONFIG         ,"regconfig"        ,',',"regconfigout"    ,quote_string,dequote_string,{0},1,0},
 {PG_REGDICTIONARY     ,"regdictionary"    ,',',"regdictionaryout",quote_string,dequote_string,{0},1,0},
 {PG_REGOPER           ,"regoper"          ,',',"regoperout"      ,quote_string,dequote_string,{0},1,0},
 {PG_REGOPERATOR       ,"regoperator"      ,',',"regoperatorout"  ,quote_string,dequote_string,{0},1,0},
 {PG_REGPROC           ,"regproc"          ,',',"regprocout"      ,quote_string,dequote_string,{0},1,0},
 {PG_REGPROCEDURE      ,"regprocedure"     ,',',"regprocedureout" ,quote_string,dequote_string,{0},1,0},
 {PG_REGTYPE           ,"regtype"          ,',',"regtypeout"      ,quote_string,dequote_string,{0},1,0},
 {PG_RELTIME           ,"reltime"          ,',',"reltimeout"      ,quote_string,dequote_string,{0},1,0},
 {PG_SMGR              ,"smgr"             ,',',"smgrout"         ,quote_string,dequote_string,{0},1,0},
 {PG_TEXT              ,"text"             ,',',"textout"         ,quote_string,dequote_string,{SQL_LONGVARCHAR},1,0},
 {PG_TID               ,"tid"              ,',',"tidout"          ,quote_geom  ,dequote_string,{0},1,0},
 ...
 {PG_TIMETZ            ,"timetz"           ,',',"timetz_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_TINTERVAL         ,"tinterval"        ,',',"tintervalout"    ,quote_string,dequote_string,{0},1,0},
 {PG_TRIGGER           ,"trigger"          ,',',"trigger_out"     ,quote_string,dequote_string,{0},1,0},
 {PG_TSQUERY           ,"tsquery"          ,',',"tsqueryout"      ,quote_string,dequote_string,{0},1,0},
 {PG_TSVECTOR          ,"tsvector"         ,',',"tsvectorout"     ,quote_string,dequote_string,{0},1,0},
 {PG_TXID_SNAPSHOT     ,"txid_snapshot"    ,',',"txid_snapshot_out",quote_string,dequote_string,{0},1,0},
 {PG_UNKNOWN           ,"unknown"          ,',',"unknownout"      ,quote_string,dequote_string,{0},1,0},
 {PG_UUID              ,"uuid"             ,',',"uuid_out"        ,quote_string,dequote_string,{0},1,0},
 {PG_VARBIT            ,"varbit"           ,',',"varbit_out"      ,quote_string,dequote_string,{0},1,0},
 {PG_VARCHAR           ,"varchar"          ,',',"varcharout"      ,quote_string,dequote_string,{SQL_VARCHAR},1,0},
 {PG_VOID              ,"void"             ,',',"void_out"        ,quote_string,dequote_string,{0},1,0},
 {PG_XID               ,"xid"              ,',',"xidout"          ,quote_string,dequote_string,{0},1,0},
 {PG_XML               ,"xml"              ,',',"xml_out"         ,quote_string,dequote_string,{0},1,0},
};
...
for my $name (sort {$a cmp $b } keys %pgtype) {
	...
	printf $newfh qq! {%-*s,%-*s,'%s',%-18s,%-12s,%-14s,\{%s\},%d,%d\},\n!,
		$maxlen, $t->{define}, $maxlen-2, "\"$name\"", $t->{delim}, "\"$t->{textout}\"", $t->{quote}, $t->{dequote}, $sql, 1, $t->{svtype};
	$pos{$name} = $item++;
}
...
for my $name (sort { $a cmp $b } keys %pgtype) {
	...
	for my $sql (split /\|/ => $pgtype{$name}{sql}) {
		...
		printf $newfh qq! {%s,"%s",',', "none", $pgtype{$name}{quote}, $pgtype{$name}{dequote}, \{$pgtype{$name}{define}\}, 1, $pgtype{$name}{svtype}\},\n!, $sql, $sql;
