...
static sql_type_info_t pg_types[] = {
	...
	{CHAROID, "char", DBDPG_FALSE, quote_string, dequote_char, {0}},
	...
	{UNKNOWNOID, "unknown", DBDPG_FALSE, quote_string, dequote_varchar, {0}},
...
static sql_type_info_t sql_types[] = {
	...
	{SQL_TYPE_DATE, "SQL_TYPE_DATE", DBDPG_TRUE, quote_string, dequote_varchar, {DATEOID}},
	{SQL_TYPE_TIME, "SQL_TYPE_TIME", DBDPG_TRUE, quote_string, dequote_varchar, {TIMEOID}},
	{SQL_TYPE_TIMESTAMP, "SQL_TYPE_TIMESTAMP", DBDPG_TRUE, quote_string, dequote_varchar, {TIMESTAMPOID}},
	{SQL_TYPE_TIMESTAMP_WITH_TIMEZONE, "SQL_TYPE_TIMESTAMP_WITH_TIMEZONE", DBDPG_TRUE, quote_string, dequote_varchar, {TIMESTAMPTZOID}},
