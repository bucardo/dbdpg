...
sql_type_info_t* pg_type_data(int sql_type)
{
    switch(sql_type) {
        ...
        case PG_PG_SNAPSHOTARRAY:        return &pg_types[39];
        case PG_POINTARRAY:              return &pg_types[40];
        case PG_POLYGONARRAY:            return &pg_types[41];
        case PG_RECORDARRAY:             return &pg_types[42];
        case PG_REFCURSORARRAY:          return &pg_types[43];
        case PG_REGCLASSARRAY:           return &pg_types[44];
        case PG_REGCOLLATIONARRAY:       return &pg_types[45];
        case PG_REGCONFIGARRAY:          return &pg_types[46];
        case PG_REGDICTIONARYARRAY:      return &pg_types[47];
        case PG_REGNAMESPACEARRAY:       return &pg_types[48];
        case PG_REGOPERARRAY:            return &pg_types[49];
        case PG_REGOPERATORARRAY:        return &pg_types[50];
        case PG_REGPROCARRAY:            return &pg_types[51];
        case PG_REGPROCEDUREARRAY:       return &pg_types[52];
        case PG_REGROLEARRAY:            return &pg_types[53];
        case PG_REGTYPEARRAY:            return &pg_types[54];
        case PG_TEXTARRAY:               return &pg_types[55];
        case PG_TIDARRAY:                return &pg_types[56];
        case PG_TIMEARRAY:               return &pg_types[57];
        case PG_TIMESTAMPARRAY:          return &pg_types[58];
        case PG_TIMESTAMPTZARRAY:        return &pg_types[59];
        case PG_TIMETZARRAY:             return &pg_types[60];
        ...
        case PG_XID8ARRAY:               return &pg_types[70];
        case PG_XMLARRAY:                return &pg_types[71];
        case PG_ACLITEM:                 return &pg_types[72];
        case PG_ANY:                     return &pg_types[73];
        case PG_ANYARRAY:                return &pg_types[74];
        case PG_ANYCOMPATIBLE:           return &pg_types[75];
        case PG_ANYCOMPATIBLEARRAY:      return &pg_types[76];
        case PG_ANYCOMPATIBLENONARRAY:   return &pg_types[77];
        case PG_ANYCOMPATIBLERANGE:      return &pg_types[78];
        case PG_ANYELEMENT:              return &pg_types[79];
        case PG_ANYENUM:                 return &pg_types[80];
        case PG_ANYNONARRAY:             return &pg_types[81];
        case PG_ANYRANGE:                return &pg_types[82];
        case PG_BIT:                     return &pg_types[83];
        case PG_BOOL:                    return &pg_types[84];
        case PG_BOX:                     return &pg_types[85];
        case PG_BPCHAR:                  return &pg_types[86];
        case PG_BYTEA:                   return &pg_types[87];
        case PG_CHAR:                    return &pg_types[88];
        case PG_CID:                     return &pg_types[89];
        case PG_CIDR:                    return &pg_types[90];
        case PG_CIRCLE:                  return &pg_types[91];
        case PG_CSTRING:                 return &pg_types[92];
        case PG_DATE:                    return &pg_types[93];
        case PG_DATERANGE:               return &pg_types[94];
        case PG_EVENT_TRIGGER:           return &pg_types[95];
        case PG_FDW_HANDLER:             return &pg_types[96];
        case PG_FLOAT4:                  return &pg_types[97];
        case PG_FLOAT8:                  return &pg_types[98];
        case PG_GTSVECTOR:               return &pg_types[99];
        case PG_INDEX_AM_HANDLER:        return &pg_types[100];
        case PG_INET:                    return &pg_types[101];
        case PG_INT2:                    return &pg_types[102];
        case PG_INT2VECTOR:              return &pg_types[103];
        case PG_INT4:                    return &pg_types[104];
        case PG_INT4RANGE:               return &pg_types[105];
        case PG_INT8:                    return &pg_types[106];
        case PG_INT8RANGE:               return &pg_types[107];
        case PG_INTERNAL:                return &pg_types[108];
        case PG_INTERVAL:                return &pg_types[109];
        case PG_JSON:                    return &pg_types[110];
        case PG_JSONB:                   return &pg_types[111];
        case PG_JSONPATH:                return &pg_types[112];
        case PG_LANGUAGE_HANDLER:        return &pg_types[113];
        case PG_LINE:                    return &pg_types[114];
        case PG_LSEG:                    return &pg_types[115];
        case PG_MACADDR:                 return &pg_types[116];
        case PG_MACADDR8:                return &pg_types[117];
        case PG_MONEY:                   return &pg_types[118];
        case PG_NAME:                    return &pg_types[119];
        case PG_NUMERIC:                 return &pg_types[120];
        case PG_NUMRANGE:                return &pg_types[121];
        case PG_OID:                     return &pg_types[122];
        case PG_OIDVECTOR:               return &pg_types[123];
        case PG_PATH:                    return &pg_types[124];
        case PG_PG_ATTRIBUTE:            return &pg_types[125];
        case PG_PG_CLASS:                return &pg_types[126];
        case PG_PG_DDL_COMMAND:          return &pg_types[127];
        case PG_PG_DEPENDENCIES:         return &pg_types[128];
        case PG_PG_LSN:                  return &pg_types[129];
        case PG_PG_MCV_LIST:             return &pg_types[130];
        case PG_PG_NDISTINCT:            return &pg_types[131];
        case PG_PG_NODE_TREE:            return &pg_types[132];
        case PG_PG_PROC:                 return &pg_types[133];
        case PG_PG_SNAPSHOT:             return &pg_types[134];
        case PG_PG_TYPE:                 return &pg_types[135];
        case PG_POINT:                   return &pg_types[136];
        case PG_POLYGON:                 return &pg_types[137];
        case PG_RECORD:                  return &pg_types[138];
        case PG_REFCURSOR:               return &pg_types[139];
        case PG_REGCLASS:                return &pg_types[140];
        case PG_REGCOLLATION:            return &pg_types[141];
        case PG_REGCONFIG:               return &pg_types[142];
        case PG_REGDICTIONARY:           return &pg_types[143];
        case PG_REGNAMESPACE:            return &pg_types[144];
        case PG_REGOPER:                 return &pg_types[145];
        case PG_REGOPERATOR:             return &pg_types[146];
        case PG_REGPROC:                 return &pg_types[147];
        case PG_REGPROCEDURE:            return &pg_types[148];
        case PG_REGROLE:                 return &pg_types[149];
        case PG_REGTYPE:                 return &pg_types[150];
        case PG_TABLE_AM_HANDLER:        return &pg_types[151];
        case PG_TEXT:                    return &pg_types[152];
        case PG_TID:                     return &pg_types[153];
        case PG_TIME:                    return &pg_types[154];
        case PG_TIMESTAMP:               return &pg_types[155];
        case PG_TIMESTAMPTZ:             return &pg_types[156];
        case PG_TIMETZ:                  return &pg_types[157];
        case PG_TRIGGER:                 return &pg_types[158];
        case PG_TSM_HANDLER:             return &pg_types[159];
        case PG_TSQUERY:                 return &pg_types[160];
        case PG_TSRANGE:                 return &pg_types[161];
        case PG_TSTZRANGE:               return &pg_types[162];
        case PG_TSVECTOR:                return &pg_types[163];
        case PG_TXID_SNAPSHOT:           return &pg_types[164];
        case PG_UNKNOWN:                 return &pg_types[165];
        case PG_UUID:                    return &pg_types[166];
        case PG_VARBIT:                  return &pg_types[167];
        case PG_VARCHAR:                 return &pg_types[168];
        case PG_VOID:                    return &pg_types[169];
        case PG_XID:                     return &pg_types[170];
        case PG_XID8:                    return &pg_types[171];
        case PG_XML:                     return &pg_types[172];
        default: return NULL;
    }
}
