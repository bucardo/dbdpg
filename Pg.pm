...

{
    ...
    use version; our $VERSION = qv('3.8.9_1');
...
This documents version 3.8.9_1 of the DBD::Pg module
...
B<'DBD::Pg ping test v3.8.9_1'>. It returns 0 (false) if the connection is not valid, 
