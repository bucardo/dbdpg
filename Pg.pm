...

{
    ...
    use version; our $VERSION = qv('3.12.3_2');
...
This documents version 3.12.3_2 of the DBD::Pg module
...
B<'DBD::Pg ping test v3.12.3_2'>. It returns 0 (false) if the connection is not valid, 
