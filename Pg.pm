...

{
    ...
    use version; our $VERSION = qv('3.21.0');
...
This documents version 3.21.0 of the DBD::Pg module
...
B<'DBD::Pg ping test v3.21.0'>. It returns 0 (false) if the connection is not valid,
