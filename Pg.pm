...

{
	...
	use version; our $VERSION = qv('3.7.2');
...
This documents version 3.7.2 of the DBD::Pg module
...
B<'DBD::Pg ping test v3.7.2'>. It returns 0 (false) if the connection is not valid, 
