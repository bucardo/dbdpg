...

{
    ...
    use version; our $VERSION = qv('3.21.1');
...
This documents version 3.21.1 of the DBD::Pg module
...
B<'DBD::Pg ping test v3.21.1'>. It returns 0 (false) if the connection is not valid,
