...
SKIP: {
    if ($@ or $Test::Pod::VERSION < $PODVERSION) {
        skip ("Test::Pod $PODVERSION is required", 9); ## nospellcheck
    }
...
SKIP: {
    ...
    if ($@ or $Test::Pod::Coverage::VERSION < $PODCOVERVERSION) {
        skip ("Test::Pod::Coverage $PODCOVERVERSION is required", 1); ## nospellcheck
    }
    ...
    my $trusted_names  =
        [
         ...
         qr{PG_ANYARRAY},
         qr{PG_ANYCOMPATIBLE},
         qr{PG_ANYCOMPATIBLEARRAY},
         qr{PG_ANYCOMPATIBLEMULTIRANGE},
         qr{PG_ANYCOMPATIBLENONARRAY},
         qr{PG_ANYCOMPATIBLERANGE},
         qr{PG_ANYELEMENT},
         qr{PG_ANYENUM},
         qr{PG_ANYMULTIRANGE},
         qr{PG_ANYNONARRAY},
         ...
         qr{PG_DATE},
         qr{PG_DATEARRAY},
         qr{PG_DATEMULTIRANGE},
         qr{PG_DATEMULTIRANGEARRAY},
         qr{PG_DATERANGE},
         ...
         qr{PG_INT4},
         qr{PG_INT4ARRAY},
         qr{PG_INT4MULTIRANGE},
         qr{PG_INT4MULTIRANGEARRAY},
         qr{PG_INT4RANGE},
         qr{PG_INT4RANGEARRAY},
         qr{PG_INT8},
         qr{PG_INT8ARRAY},
         qr{PG_INT8MULTIRANGE},
         qr{PG_INT8MULTIRANGEARRAY},
         qr{PG_INT8RANGE},
         ...
         qr{PG_TRIGGER},
         qr{PG_TSMULTIRANGE},
         qr{PG_TSMULTIRANGEARRAY},
         qr{PG_TSM_HANDLER},
         qr{PG_TSQUERY},
         qr{PG_TSQUERYARRAY},
         qr{PG_TSRANGE},
         qr{PG_TSRANGEARRAY},
         qr{PG_TSTZMULTIRANGE},
         qr{PG_TSTZMULTIRANGEARRAY},
         qr{PG_TSTZRANGE},
