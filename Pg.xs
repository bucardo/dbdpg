...
constant(name=Nullch)
    ...
    PG_INT4MULTIRANGEARRAY       = 8010
    PG_INT4RANGE                 = 3904
    PG_INT4RANGEARRAY            = 3905
    PG_INT8                      = 20
    PG_INT8ARRAY                 = 1016
    PG_INT8MULTIRANGE            = 4536
    PG_INT8MULTIRANGEARRAY       = 8020
    PG_INT8RANGE                 = 3926
